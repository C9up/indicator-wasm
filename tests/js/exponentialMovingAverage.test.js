...
import { exponentialMovingAverage } from '../../dist/index.js'
...
test.group('ExponentialMovingAverage', () => {
    ...
    test('test insufficient data returns array of NaNs', ({ assert }) => {
        // Si le nombre de données est inférieur à la période, la fonction doit retourner un tableau rempli de NaN.
